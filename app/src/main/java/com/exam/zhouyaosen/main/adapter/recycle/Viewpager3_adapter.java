...
public class Viewpager3_adapter extends Viewpager2_adapter {
    Context context;
    ...
    public Viewpager3_adapter(Context context, List<NovelContentPage> pagination_l, List<NovelContentPage> pagination, List<NovelContentPage> pagination_n, int po, int textColor, int textsize, int lines, float letter) {
    ...
    public Viewpager2_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        } else view = LayoutInflater.from(context).inflate(R.layout.lookbook_item3, parent, false);

        return new Viewpager2_adapter.ViewHolder(view);
    }
