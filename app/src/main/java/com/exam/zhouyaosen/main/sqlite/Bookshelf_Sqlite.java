...
public class Bookshelf_Sqlite extends SQLiteOpenHelper {
    ...
    public Bookshelf_Sqlite(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public boolean checkTitleExists(String title) {
        ...
        // Perform a query to check if the title exists
